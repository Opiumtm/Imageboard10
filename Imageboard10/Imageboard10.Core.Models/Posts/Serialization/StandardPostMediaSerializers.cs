...
namespace Imageboard10.Core.Models.Posts.Serialization
{
    ...
    public sealed class StandardPostMediaSerializers : ObjectSerializersProviderBase
    {
        ...
        {
            yield return new StandardObjectSerializer<PostMedia.PostMedia, PostMediaBase>(new PostMediaSerializerCustomization<PostMedia.PostMedia>(), "postmedia:std");
            yield return new StandardObjectSerializer<PostMediaWithSize, PostMediaBase>(new PostMediaSerializerCustomization<PostMediaWithSize>(), "postmedia:std:w/size");
            yield return new StandardObjectSerializer<PostMediaWithThumbnail, PostMediaBase>(new PostMediaWithThumbnailSerializerCustomization<PostMediaWithThumbnail>(), "postmedia:std:w/thumbnail");
