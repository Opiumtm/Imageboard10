...
namespace Imageboard10.Core.Models.Links.LinkTypes
{
    ...
    public class EngineMediaLink : EngineLinkBase, IUriLink
    {
        ...
        public override string GetLinkHash() => $"enginemedia-{Engine}-{Uri?.ToLowerInvariant()}";
        ...
        public override string GetFilesystemFriendlyId() => $"enginemedia-{Engine}-{Utility.StringHashCache.GetHashId((Uri ?? "").ToLowerInvariant())}";
    }
}